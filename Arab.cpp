...
void display() {
    ...
    int flagWidth = 750;  // Adjust this according to your flag's width
    int flagHeight = 500; // Adjust this according to your flag's height
    ...
    // Draw the red, white, and black stripes
